...
${OBJECTDIR}/lib/API_Leitura.o: lib/API_Leitura.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/API_Leitura.o lib/API_Leitura.c

${OBJECTDIR}/lib/API_Utils.o: lib/API_Utils.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/API_Utils.o lib/API_Utils.c

${OBJECTDIR}/lib/FuncoesGerais.o: lib/FuncoesGerais.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/FuncoesGerais.o lib/FuncoesGerais.c

${OBJECTDIR}/lib/GestaoEncomendas.o: lib/GestaoEncomendas.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/GestaoEncomendas.o lib/GestaoEncomendas.c

${OBJECTDIR}/lib/GestaoTabelaPrecos.o: lib/GestaoTabelaPrecos.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/GestaoTabelaPrecos.o lib/GestaoTabelaPrecos.c

${OBJECTDIR}/lib/GestaoUtilizadores.o: lib/GestaoUtilizadores.c
	${MKDIR} -p ${OBJECTDIR}/lib
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib/GestaoUtilizadores.o lib/GestaoUtilizadores.c
